...
const dict = {
  en: {
    ...
    settings_subtitle: "Configure how your AI receptionist talks and where leads go.",
    business: "Business",
    business_name: "Business name",
    short_desc: "Short description",
    short_desc_hint: "One or two sentences about what you do.",
    kb: "Knowledge base",
    kb_hint: "Add the FAQs your AI receptionist should answer — prices, services, opening hours, policies. The AI uses ONLY this info to answer customers, in English or French.",
    test_ai: "Test the AI",
  ...
  fr: {
    ...
    settings_subtitle: "Configurez la voix de votre réceptionniste IA et la destination des prospects.",
    business: "Entreprise",
    business_name: "Nom de l'entreprise",
    short_desc: "Brève description",
    short_desc_hint: "Une ou deux phrases sur votre activité.",
    kb: "Base de connaissances",
    kb_hint: "Ajoutez les FAQ auxquelles votre réceptionniste IA doit répondre — tarifs, services, horaires, politiques. L'IA n'utilise QUE ces informations pour répondre, en français ou en anglais.",
    test_ai: "Tester l'IA",
